...
function UserContentProvider({ children }) {
    ...
    const { getCollectionContents, addCollectionContent, updateCollectionContent, deleteCollectionContent, getStatus: getColConStatus, colContents, postStatus: postColConStatus } = useCollectionsContents(USER_COLLECTION_URL_BASE, addStatusMessage);


    return (
        <UserContentContext.Provider value={{
            collections, getCollections, getCollectionContents,
            addCollectionContent, updateCollectionContent, deleteCollectionContent, addStatusMessage, statusMessageQueue, getColConStatus, postColConStatus,  colContents
        }}>
            {children}
